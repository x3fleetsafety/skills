---
name: owner-operator-tax-and-deductions
description: |
  Use when an owner-operator (1099 or LLC/S-corp) asks how to lower their tax bill, what they can deduct,
  per diem treatment, depreciation choices (Section 179, bonus, MACRS), quarterly estimated payments,
  S-corp salary vs distributions, retirement plan options (SEP-IRA, Solo 401(k)), or recordkeeping
  requirements. Covers federal income tax + self-employment tax basics; not state-specific.
---
