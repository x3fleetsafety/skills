---
name: fmcsa-pre-employment-investigation-deep-dive
description: |
  Use when a carrier asks about the full pre-employment investigation process for new CDL drivers
  under 49 CFR 391.23, 391.25, 391.27, 382.413, and 391.21 — the complete file build required before
  a driver operates a CMV. Covers application, MVR, employment history, drug/alcohol history,
  PSP, Clearinghouse, road test, and documentation requirements.
---
