---
name: electric-truck-readiness
description: |
  Use when a carrier asks about electric trucks — Tesla Semi, Freightliner eCascadia, Volvo VNR
  Electric, Peterbilt 579EV, range, charging, total cost of ownership, regulatory pushes (CARB
  ACT, ACF), incentives, infrastructure, depot vs en-route charging, and which routes/applications
  are EV-ready today.
---
